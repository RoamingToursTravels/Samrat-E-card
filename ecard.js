...
function saveContact() {
    const name = 'FARIA NOOR NETU';
    const organization = 'Roaming Tours & Travels';
    const title = 'VISA SUPPORT';
    const officePhone = '8801332547047';
    const personalPhone = '8801825739843';
    const email = 'roamingnoornitu@gmail.com';
...
function openWhatsApp() {
    const whatsappNumber = '8801825739843';
